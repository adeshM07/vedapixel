...
const AboutPage = () => {
  ...
  return (
    <>
      ...
      "
            >
              <p className="about-card-title font-semibold text-[1rem] sm:text-[1.2rem] md:text-[1.4rem] lg:text-[1.6rem] 2xl:text-[1.8rem] [@media(min-width:2500px)]:text-[3rem] text-[#F8F9FA] leading-tight">
                Our Mission
              </p>
              <p className="mt-1 sm:mt-2 md:mt-3 text-[7px] md:text-[1.1rem] lg:text-[1.25rem] 2xl:text-[1.35rem] [@media(min-width:2000px)]:text-[2.4rem] text-[#C8C1C1] leading-relaxed sm:leading-normal md:leading-relaxed">
      ...
      "
            >
              <p className="about-card-title font-semibold text-[1rem] sm:text-[1.2rem] md:text-[1.4rem] lg:text-[1.6rem] 2xl:text-[1.8rem] [@media(min-width:2000px)]:text-[3rem] text-[#F8F9FA] leading-tight">
                Our Vision
              </p>
              <p className="mt-1 sm:mt-2 md:mt-3 text-[7px] md:text-[1.1rem] lg:text-[1.25rem] 2xl:text-[1.35rem] [@media(min-width:2000px)]:text-[2.4rem] text-[#C8C1C1] leading-relaxed sm:leading-normal md:leading-relaxed">
        ...
        w-[32.5%] h-[15vh] md:w-[32vw] lg:w-[29vw] 2xl:w-[22vw]
         min-h-[16vh] sm:min-h-[20vh] md:h-[22vh] lg:h-fit 2xl:h-[42vh]
        px-4 sm:px-6 md:px-7 py-3 sm:py-5
        transition-all duration-300 [@media(min-width:2500px)]:w-[24vw] [@media(min-width:2500px)]:h-[38vh]
      "
            >
              <p className="about-card-title font-semibold text-[1rem] sm:text-[1.2rem] md:text-[1.4rem] lg:text-[1.6rem] 2xl:text-[1.8rem] [@media(min-width:2000px)]:text-[3rem] text-[#F8F9FA] leading-tight">
                Our Story

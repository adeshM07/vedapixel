  ...
  return (
    <>
      ...
      >
        ...
        <motion.div
          id="layout"
          className="w-[90%] lg:w-[90%] 2xl:w-[66%] mx-auto flex flex-col items-center  md:gap-8"
      ...
      "
            >
              ...
              <p className="mt-1 sm:mt-2 md:mt-3 text-[7px] md:text-[1.1rem] lg:text-[1.25rem] 2xl:text-[1.35rem] text-[#C8C1C1] leading-relaxed sm:leading-normal md:leading-relaxed">
